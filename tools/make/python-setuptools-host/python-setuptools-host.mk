#PYTHON_SETUPTOOLS_HOST_VERSION:=28.5.0
PYTHON_SETUPTOOLS_HOST_MD5:=
PYTHON_SETUPTOOLS_HOST_SOURCE_COMMIT:=5af3d09
...
$(PYTHON_SETUPTOOLS_HOST_DIR)/.unpacked: $(DL_DIR)/$(PYTHON_SETUPTOOLS_HOST_SOURCE) | $(TOOLS_SOURCE_DIR) $(UNPACK_TARBALL_PREREQUISITES) python-host libffi-host
