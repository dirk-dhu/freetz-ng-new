...
echo
echo -e '# Temporär verfügbare Firmware-Dateien auf [ftp.avm.de/](https://ftp.avm.de/)'
echo -e ' - Das Unterverzeichnis [archive/](https://ftp.avm.de/archive/) ist hier nicht enthalten.'
