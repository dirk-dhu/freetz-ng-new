 ...
 * fritzsmart-gateway/
   - deutschland: [FRITZ.Smart_Gateway-07.57-Release.image](https://download.avm.de/fritzwlan/fritzsmart-gateway/deutschland/fritz.os/FRITZ.Smart_Gateway-07.57-Release.image)
