 ...
 * fritzsmart-gateway/
   - [source-files-FRITZ.Smart_Gateway-maple_lowmem-07.57.tar.gz](https://osp.avm.de/fritzwlan/fritzsmart-gateway/source-files-FRITZ.Smart_Gateway-maple_lowmem-07.57.tar.gz)
