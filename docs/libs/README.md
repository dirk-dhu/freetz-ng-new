...
### F
  ...
  * **[FreeType (freetype.so) 2.13.0](freetype.md)<a id='freetype'></a>**<br>
...
### L
  ...
  * **[libuv (libuv.so) $(if $(FREETZ_TARGET_GCC_4_8_MAX),1.44.2,1.45.0)](libuv.md)<a id='libuv'></a>**<br>
...
### N
  ...
  * **[nettle: libnettle (libnettle.so) 3.9](nettle.md)<a id='nettle'></a>**<br>
