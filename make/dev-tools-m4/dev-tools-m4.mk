...
$(PKG)_SOURCE_MD5:=a077779db287adf4e12a035029002d28
...
$(PKG)_CONFIGURE_PRE_CMDS += find $(abspath $($(PKG)_DIR)) -name Makefile.in -type f -exec $(SED) -i -r -e 's~LDADD = ../lib/libm4.a(.*)~LDADD = ../lib/libm4.a\1 \$$$\$$$\(LIB_POSIX_SPAWN\)~'   \{\} \+;
