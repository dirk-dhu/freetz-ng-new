...
check "$EIBD_ENABLED" yes:auto "*":man
check "$EIBD_LOG_DISABLE" yes:log_disable_yes "*":log_disable_no
...
sec_end
sec_begin '$(lang de:"EIBD Serverkonfiguration" en:"EIBD server configuration")'

cat << EOF
<p>$(lang de:"EIBnet/IP Tunnel" en:"EIBnet/IP tunnel"):<br>
<input type="text" name="address" size="40" maxlength="255" value="$(html "$EIBD_ADDRESS")"><br>
...
<p> $(lang de:"Startparameter" en:"Start parameters"): <input type="text" name="special" size="45" maxlength="255" value="$(html "$EIBD_SPECIAL")"></p>
...
<input type="text" name="log_file" size="45" maxlength="200" value="$(html "$EIBD_LOG_FILE")"></label>
</p>
EOF
