...
$(PKG)_DEPENDS_ON += $(if $(FREETZ_PACKAGE_TRANSMISSION_VERSION_ABANDON),cmake-host)
...
$(PKG)_CONFIGURE_OPTIONS += -DCDEFLATE_INCLUDE_DIR="$(TARGET_TOOLCHAIN_STAGING_DIR)/usr"
