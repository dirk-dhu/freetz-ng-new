$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_OPENVPN_VERSION_24),2.4.12,$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_25),2.5.9,2.6.7)))
...
$(PKG)_HASH_26:=ee9877340b1d8de47eb5b52712c3366855fa6a4a1955bf950c68577bd2039913
