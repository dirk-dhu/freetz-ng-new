$(call PKG_INIT_BIN,$(if $(FREETZ_OPENSSL_VERSION_0),0.9.8zh,$(if $(FREETZ_OPENSSL_VERSION_1),1.0.2u,$(if $(FREETZ_OPENSSL_VERSION_3),3.0.7,1.1.1s))))
...
$(PKG)_HASH_1.1:=c5ac01e760ee6ff0dab61d6b2bbd30146724d063eb322180c6f18a6f74e4b6aa
$(PKG)_HASH_3.0:=83049d042a260e696f62406ac5c08bf706fd84383f945cf21bd61e9ed95c396e
...
$(PKG)_NO_CIPHERS += $(if $(FREETZ_OPENSSL_VERSION_1_MAX),no-sha0 no-smime no-aes192 $(if $(FREETZ_PACKAGE_PERL_NETSSLEY),,no-ripemd) no-rmd160 no-ans1 no-krb5)
