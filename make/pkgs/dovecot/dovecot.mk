$(call PKG_INIT_BIN, 2.3.21)
$(PKG)_SOURCE:=dovecot-$($(PKG)_VERSION).tar.gz
$(PKG)_HASH:=05b11093a71c237c2ef309ad587510721cc93bbee6828251549fc1586c36502d
...
# doveconf Panic: file mempool-system.c: line 136 (pool_system_realloc): assertion failed: (old_size == SIZE_MAX || mem == NULL || old_size <= malloc_usable_size(mem)) Aborted
$(PKG)_CONFIGURE_ENV += ac_cv_func_malloc_usable_size=no
