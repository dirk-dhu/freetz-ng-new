...
$(PKG)_SOURCE_MD5_1.12.3:=35ad1f9e1003cac9404c1493eb10d7f5
$(PKG)_HASH:=$($(PKG)_SOURCE_MD5_$($(PKG)_VERSION))
...
$(PKG)_SITE_1.12.3:=https://files.pythonhosted.org/packages/93/1a/ab8c62b5838722f29f3daffcc8d4bd61844aa9b5f437341cc890ceee483b
...
$(DL_DIR)/$($(PKG)_SOURCE):: | $(DL_DIR)
	$(DL_TOOL) $(DL_DIR) $($(PKG)_SOURCE) $($(PKG)_SITE) $($(PKG)_HASH)
