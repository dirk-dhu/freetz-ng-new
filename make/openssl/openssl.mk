$(call PKG_INIT_BIN,$(if $(FREETZ_OPENSSL_VERSION_0),0.9.8zh,$(if $(FREETZ_OPENSSL_VERSION_1),1.0.2u,$(if $(FREETZ_OPENSSL_VERSION_3),3.0.0-alpha12,1.1.1j))))
...
$(PKG)_SOURCE_SHA256_1.1:=aaf2fcb575cdf6491b98ab4829abf78a3dec8402b8b81efc8f23c00d443981bf
$(PKG)_SOURCE_SHA256_3.0:=8d78239be66af578b969441252e7c125aa134ef3b9bac6179d84275cfe01950c
